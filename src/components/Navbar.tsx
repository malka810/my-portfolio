    ...
    <nav className="fixed w-full z-50 shadow-md bg-gradient-to-br from-black via-gray-900 to-[#1a0d0d]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
         <div className="text-3xl font-semibold text-white tracking-wide animate-pulse drop-shadow-[0_0_10px_rgba(99,102,241,0.8)]">
            mALKA
         </div>

          <div className="hidden md:flex space-x-10 text-white text-lg font-medium">
          ...
          <div className="md:hidden">
            ...
            >
              <i
                className={`bx ${isOpen ? "bx-x" : "bx-menu"} text-3xl transition duration-300`}
              ></i>
            </button>
          </div>
        </div>
      ...
      <div
        className={`md:hidden fixed top-16 left-0 w-full bg-gradient-to-br from-black via-gray-900 to-[#1a0d0d] transition-all duration-300 ease-in-out overflow-hidden ${
          isOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"
        }`}
      >
        <div className="flex flex-col items-center space-y-4 py-6 text-white font-medium">
